...
# Packages: "TTR" for time series functions, "forecast" for forecasting, "ggplot2" for plotting
...
sum(logsouvenir.forecasts2$residuals^2)
...
acf(logsouvenir.forecasts2$residuals, lag.max=24)
...
mean(logsouvenir.forecasts2$residuals)
...
plotForecastErrors(logsouvenir.forecasts2$residuals)
...
souvenir.ts ; logsouvenir.forecasts$fitted
